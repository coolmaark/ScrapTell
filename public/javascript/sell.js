                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 py-3 ">
                        <div class="card cat-items">
                            ...
                            <div class="card-body">
                                <h4 >${item.name}</h4>
                                <h3>${item.price}</h3> 
                                <button class="add-to-cart" onclick="start()">Sell Us
...
//     if(cartItem.some(items) => items.id === id){
//         alert("Product alreardy exist");
//     }
//     else{
//         const items=categories.find((category)=>categories.id === id);
//         cartItem.push(items);
//         console.log(id);
//     }
// }
